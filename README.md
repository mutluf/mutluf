...
💻 Tech Stack:
- Backend: NestJS, .NET, C#, Java, SpringBoot
- Frontend: React, Next.js, TailwindCSS, Syncfusion UI Component (React)
- Databases: MS SQL Server, MongoDB, PostgreSQL
- Messaging & Background Jobs: RabbitMQ, Hangfire
- Tools & DevOps: Docker, Git, Postman, Swagger
